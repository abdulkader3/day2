        ...
        <div className="container pl-[53px] pr-[167px]  ">
          ...
          <div className="business_row flex gap-[103px] ">
            ...
            <div className="leftpart">
              <h2
                className="w-[328px]
                    text-[40px] font-roboto font-normal mt-[357px] text-[#000000]"
              >
            ...
            <div className="right_part flex gap-[33px]">
              ...
              <div className="first_card_row flex flex-col gap-[30px]">
                ...
                <div
                  className="business_card bg-[#FFFFFF] mt-[79px] w-[298px] pt-[39px]
                         pb-[57px] px-[30px] border border-[#F2F2F2] rounded-[40px] flex flex-col justify-center items-center gap-[31px]"
                >
                  <div className="img">
                    <img src={box} alt="err" />
                  </div>
                  <h2 className="text-center text-[24px] font-normal font-roboto">
                ...
                <div
                  className="web_card  bg-[#FFFFFF] w-[298px] pt-[39px]
                         pb-[57px] px-[30px] border border-[#F2F2F2] rounded-[40px] flex flex-col justify-center items-center gap-[31px]"
                >
                  <div className="img">
                    <img src={web} alt="err" />
                  ...
                  <h2 className="text-center text-[24px] font-normal font-roboto">
                    Development
                    <span className="block">Website and App</span>
                  </h2>
                  <p
                    className="text-center text-base font-normal font-roboto text-[#757575]
                             "
                  >
              ...
              <div className="second_card_row mt-[30px] flex flex-col gap-[30px]">
                ...
                <div
                  className="fin_card bg-[#FFFFFF] w-[298px] pt-[39px]
                         pb-[57px] px-[30px] border border-[#F2F2F2] rounded-[40px] flex flex-col justify-center items-center gap-[31px]"
                >
                  <div className="img">
                    <img src={fin} alt="err" />
                  ...
                  <p
                    className="text-center text-base font-normal font-roboto
                              text-[#757575]"
                  >
                    {" "}
                ...
                <div
                  className="market_card bg-[#FFFFFF] w-[298px] pt-[39px]
                         pb-[57px] px-[30px] border border-[#F2F2F2] rounded-[40px] flex flex-col justify-center items-center gap-[31px]"
                >
                  <div className="img">
