...
<div className="container px-[120px]">
      <div className='flex gap-[80px]'>
          ...
          <img src={digital} alt="" className='w-[550px] h-[372px]'  data-aos="zoom-in"/>
          <img src={ellipse} alt="" className='w-[129px] h-[129px] absolute left-[416px] top-[249px] z-[-1] ' data-aos="flip-left"/>
      ...
      <div className='relative'>
        ...
        <p className='w-[532px] h-[104px] text-[#565656] font-roboto mt-[34px] dark:font-semibold'>Our Business Plan is a written document describing a company's core business activites, Objectives, and how it plans to achieve its goals. Our goal is to provide our client high quality Product with modern idea accordingly their budgets and according thir reuirements.</p>
      <img src={rectangle} alt="" className='w-[178px] h-[178px] absolute top-[199px] z-[-1] left-[-31px]' data-aos="flip-right"/>
      </div>
      </div>
